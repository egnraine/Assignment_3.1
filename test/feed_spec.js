...
<><p>var frisby = require('frisby');
    ...
    var dbConfig = require('./config/db.js');</p><p>var dilbertFeedURL = 'http://feeds.feedburner.com/DilbertDailyStrip';
        ...
        <p>async.series([addEmptyFeedListTest, subOneFeed, subDuplicateFeed, subSecondFeed, subOneFeedSecondUser]);</p></p></>